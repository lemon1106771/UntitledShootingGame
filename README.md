...
* **Dynamic Arsenal:** Choose between three distinct weapons, each with unique fire rates, spread, and custom sound effects:
  ...
  * **Shotgun:** Close-range burst damage with pellet spread.
  * **Rifle:** Fully automatic fire for clearing crowds.
* **Resource Management:** Every gun has its own magazine size and reloading mechanics to keep combat tense.
* **Diverse Enemies:** Face off against jumping red ground troops and bouncing yellow flying drones that shoot back.
* **Health Drops:** Defeated enemies have a 10% chance to drop a health pack to keep your run alive.
